...
# Look at movement in first row covariate, limiting to cases where there was
# Only 1 column covariate
out.pr5$beta_col1_ciwidth <- out.pr5$beta_col1_95q - out.pr5$beta_col1