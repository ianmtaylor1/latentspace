...
results <- read.csv("Results/imt_results.csv", header=TRUE, stringsAsFactors=FALSE)
...
aggregate <- unique(results[,c("Run","Xseed","Z_additive","Z_multiplicative","AddRE","MulRE","Variable","TrueValue")])
