...
jobname <- "normal" # How to name the output file
...
results <- foreach(rep=reps, .combine="rbind") %dopar% {
  ...
  Y_normal_noZ <- eta          # Data generated WITHOUT unobserved covariate
  Y_normal <- eta + Z * gamma  # Data generated WITH unobserved covariate
  
  #### Fit models and record confidence intervals
  arglists <- list(list(Y=Y_normal_noZ, Z=FALSE, Xdyad=Xd, rvar=FALSE, cvar=FALSE, dcor=FALSE, R=0, plot=FALSE, print=FALSE, model="nrm", gof=FALSE, nscan=mcmc.iter),
                   list(Y=Y_normal_noZ, Z=FALSE, Xdyad=Xd, rvar=TRUE, cvar=TRUE, dcor=FALSE, R=0, plot=FALSE, print=FALSE, model="nrm", gof=FALSE, nscan=mcmc.iter),
                   list(Y=Y_normal_noZ, Z=FALSE, Xdyad=Xd, rvar=FALSE, cvar=FALSE, dcor=FALSE, R=1, plot=FALSE, print=FALSE, model="nrm", gof=FALSE, nscan=mcmc.iter),
                   list(Y=Y_normal_noZ, Z=FALSE, Xdyad=Xd, rvar=TRUE, cvar=TRUE, dcor=FALSE, R=1, plot=FALSE, print=FALSE, model="nrm", gof=FALSE, nscan=mcmc.iter),
                   list(Y=Y_normal, Z=TRUE, Xdyad=Xd, rvar=FALSE, cvar=FALSE, dcor=FALSE, R=0, plot=FALSE, print=FALSE, model="nrm", gof=FALSE, nscan=mcmc.iter),
                   list(Y=Y_normal, Z=TRUE, Xdyad=Xd, rvar=TRUE, cvar=TRUE, dcor=FALSE, R=0, plot=FALSE, print=FALSE, model="nrm", gof=FALSE, nscan=mcmc.iter),
                   list(Y=Y_normal, Z=TRUE, Xdyad=Xd, rvar=FALSE, cvar=FALSE, dcor=FALSE, R=1, plot=FALSE, print=FALSE, model="nrm", gof=FALSE, nscan=mcmc.iter),
                   list(Y=Y_normal, Z=TRUE, Xdyad=Xd, rvar=TRUE, cvar=TRUE, dcor=FALSE, R=1, plot=FALSE, print=FALSE, model="nrm", gof=FALSE, nscan=mcmc.iter)
  )
